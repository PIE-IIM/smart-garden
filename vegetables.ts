...
export const vegetablesFixture: Vegetable[] = [
  ...
  },
  {
    ...
    semis: ['février', 'mars', 'avril', 'mai', 'août', 'septembre', 'octobre'],
    plantation: ['mars', 'avril', 'mai', 'septembre'],
    recolte: ['avril', 'mai', 'juin', 'octobre', 'novembre', 'décembre'],
  ...
  },
  {
    ...
    semis: ['mars', 'avril', 'mai', 'juin', 'juillet', 'août', 'septembre'],
    plantation: [],
    recolte: [
      'avril',
      'mai',
  ...
  },
  {
    ...
    caracteristiques: [
      'Racine longue',
      'Pousse lente',
      'Sensibles aux cailloux',
    ],
    semis: ['mars', 'avril', 'mai', 'juin', 'juillet'],
    plantation: [],
    recolte: ['juin', 'juillet', 'août', 'septembre', 'octobre', 'novembre'],
  ...
  },
  {
    ...
    semis: ['avril', 'mai'],
    plantation: ['mai', 'juin'],
    recolte: ['juillet', 'août', 'septembre'],
  ...
  },
  {
    ...
    semis: ['février', 'mars', 'avril', 'août', 'septembre'],
    plantation: ['mars', 'avril', 'septembre'],
    recolte: ['mai', 'juin', 'juillet', 'octobre'],
  ...
  },
  {
    ...
    semis: ['mars', 'avril', 'mai', 'juin', 'juillet', 'août'],
